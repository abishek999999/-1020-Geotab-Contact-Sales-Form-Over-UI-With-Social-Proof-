  ...
  function initVar() {
    var submitCTAInterval = setInterval(async function () {
      if (
        ...
        // Adding Logo
        document
          .querySelector(".spz_t1020TC .formWrapper .formcontainer")
          .insertAdjacentHTML(
            "afterbegin",
            `<picture>
        ...
        // ADding steps
        if (!document.querySelector(".spz_t1020TC .formWrapper .steps")) {
          document
            .querySelector(".spz_t1020TC .formWrapper h2")
            .insertAdjacentHTML(
              "beforebegin",
              `
                      <div class="steps">
        ...
        document.querySelector(
          ".spz_t1020TC .formWrapper .form-field.multiple_region_select__c label"
        ...
        document
          .querySelectorAll(
            `.spz_t1020TC .formWrapper .MuiGrid-item.first_name,
              .spz_t1020TC .formWrapper .MuiGrid-item.last_name,
              .spz_t1020TC .formWrapper .MuiGrid-item.company,
              .spz_t1020TC .formWrapper .MuiGrid-item.Title__c,
              .spz_t1020TC .formWrapper .MuiGrid-item.email,
              .spz_t1020TC .formWrapper .MuiGrid-item.industry,
              .spz_t1020TC .formWrapper .continue`
          )
        ...
        document
          .querySelectorAll(
            `.spz_t1020TC .formWrapper .MuiGrid-item.multiple_region_select__c,
            .spz_t1020TC .formWrapper .MuiGrid-item.fleet_size,
            .spz_t1020TC .formWrapper .MuiGrid-item.country,
            .spz_t1020TC .formWrapper .MuiGrid-item.city,
            .spz_t1020TC .formWrapper .MuiGrid-item.state,
            .spz_t1020TC .formWrapper .showComment,
            .spz_t1020TC .formWrapper .privacyPolicy,
            .spz_t1020TC .formWrapper .MuiGrid-item.phone,
            .How_Did_You_Hear_About_Geotab__select,
            .spz_t1020TC .formWrapper .submitWrapper
            `
          )
        ...
        fields.forEach((field, index) => {
          const element = document.querySelector(".spz_t1020TC " + field);
          if (element) {
        ...
        document
          .querySelector(".spz_t1020TC .formWrapper .continue")
          .addEventListener("click", function () {
            var allFieldsFilled = 0;
            var checkfields = document.querySelectorAll(
              ".spz_t1020TC .formWrapper .step1Field input, .spz_t1020TC .formWrapper .step1Field select"
            );
            var emptyFields = [];
            ...
            if (allFieldsFilled === checkfields.length) {
              var emailInput = document.querySelector(
                ".spz_t1020TC .formWrapper .MuiGrid-item.email input"
              );
              var email = emailInput.value.trim();
              if (isValidEmail(email)) {
                document
                  .querySelectorAll(".spz_t1020TC .formWrapper .step1Field")
                  .forEach(function (step1Field) {
                    step1Field.style.display = "none";
                  });
                document
                  .querySelector(".spz_t1020TC .formWrapper .MuiGrid-container")
                  .classList.add("step1Filled");
                step2Visible();

                document.querySelector(
                  ".spz_t1020TC .formWrapper .steps"
                ).innerHTML = `
        ...
        function step2Visible() {
          if (
            document.querySelector(
              ".spz_t1020TC .formWrapper .MuiGrid-container.step1Filled"
            )
          ) {
            document
              .querySelectorAll(
                ".spz_t1020TC .formWrapper .step2Field:not(.city)"
              )
              .forEach(function (step2Field) {
            ...
            var tabletCountryValue = document.querySelector(
              ".spz_t1020TC .formWrapper form .form-field.country select"
            );
            if (
              ...
              document.querySelector(
                ".spz_t1020TC .formWrapper form .form-field.city"
              ).style.display = "block";
            }

            var desktopCountryValue = document.querySelector(
              ".spz_t1020TC .formWrapper form .form-field.country #country"
            );
            if (
            ...
            function (mutation) {
              if (
                ...
                if (
                  ...
                  if (
                    document.querySelector(
                      ".spz_t1020TC .formWrapper .MuiGrid-item.subIndustry"
                    )
                  ) {
                    document.querySelector(
                      ".spz_t1020TC .formWrapper form .form-field.city"
                    ...
                    document.querySelector(
                      ".spz_t1020TC .formWrapper form .form-field.country"
                    ).style.maxWidth = "calc(50% - 10px)";
                    document.querySelector(
                      ".spz_t1020TC .formWrapper form .form-field.country"
                    ).style.flexBasis = "calc(50% - 10px)";
              ...
              document.querySelector(
                ".spz_t1020TC .How_Did_You_Hear_About_Geotab__select"
              ).style.maxWidth = "calc(50% - 10px)";
              document.querySelector(
                ".spz_t1020TC .How_Did_You_Hear_About_Geotab__select"
              ).style.flexBasis = "calc(50% - 10px)";
          ...
          if (
            ...
            observeElementChanges(
              ...
              function (mutation) {
                ...
                document
                  .querySelector(".spz_t1020TC .formWrapper .industry")
                  .after(
                    document.querySelector(
                      ".spz_t1020TC .formWrapper .subIndustry"
                    )
                  );
        ...
        observeElementChanges(
          ".spz_t1020TC .formWrapper .MuiGrid-container",
          "childList",
          function (mutation) {
            if (
              document.querySelectorAll(
              ...
              fieldsStatesLogic(
                document.querySelector(
                  ".formWrapper .MuiGrid-item div#industry"
                )
              );
              handleDesktopSelectClasses(
                document.querySelectorAll(
            ...
            if (
              document.querySelectorAll(
                ".spz_t1020TC .formWrapper form .form-field.industry"
              ).length < 1 &&
              window.innerWidth < 960
            ) {
              document
              ...
              fieldsStatesLogic(
                document.querySelector(
                  ".formWrapper .MuiGrid-item select#industry"
                )
              );
        ...
        if (countrySelect) {
          countrySelect.addEventListener("change", function (event) {
            if (event.target.value == "US") {
              ...
              document.querySelector(
                ".spz_t1020TC .formWrapper form .form-field.city #city"
              ).value = "";
        ...
        document
          .querySelector(".spz_t1020TC .formWrapper .submitWrapper button")
          .addEventListener("click", function () {
            document.querySelector("#How_Did_You_Hear_About_Geotab__c").value =
              document.querySelector(
                ".spz_t1020TC .How_Did_You_Hear_About_Geotab__select .MuiInputBase-input"
              ).value;
          });
        ...
        function multipleRegionSelect() {
          if (
            window.innerWidth < 960 &&
            document.querySelectorAll(
              ".spz_t1020TC .formWrapper select#multiple_region_select__c"
            ).length > 0 &&
          ...
          `
            ...
            if (
              ...
              document
                .querySelector(
                  ".spz_t1020TC .formWrapper .form-field.multiple_region_select__c .MuiInputBase-root"
                )
                .insertAdjacentHTML(
                  "afterend",
                  `
          ...
          `
            ...
            const checkboxDropdown = document.querySelector(
              ".spz_t1020TC .formWrapper .checkbox-dropdown"
            );
            const dropdownList = document.querySelector(
              ".spz_t1020TC .formWrapper .checkbox-dropdown ul"
            );
            ...
            document.addEventListener("click", function (event) {
              ...
              if (!isClickInsideDropdown) {
                ...
                if (
                  document.querySelectorAll(
                    ".spz_t1020TC .formWrapper .optionsSelected"
                  ).length > 0
                ) {
                  if (
                    document.querySelector(
        ...
        document
          .querySelector(
            '.spz_t1020TC .formSection .formWrapper button[type="submit"]'
          )
          .addEventListener("click", function () {
            var allFieldsFilled = 0;
            var checkfields = document.querySelectorAll(
              '.spz_t1020TC .formWrapper .step2Field input.MuiSelect-nativeInput:not([placeholder="Select at least two options"]), .spz_t1020TC .formWrapper .step2Field input.MuiInputBase-input, .spz_t1020TC .formWrapper .step2Field select:not(#multiple_region_select__c)'
            );
            var emptyFields = [];
          ...
          if (window.outerWidth >= 960) {
            function clickEventListener(event) {
              var inputsToCheck = document.querySelectorAll(
                ".spz_t1020TC form .MuiInputBase-root .MuiSelect-select + input"
              );
              inputsToCheck = Array.from(inputsToCheck);
              if (
                !event.target.classList.contains("spz_t1020TC") &&
        ...
        hiddenValue("spiralyze_conversion_tag_demo", "1020_TC");
      ...
      if (!document.querySelector("checkboxPrivacy")) {
        var containerInterval = setInterval(function () {
          if (
            document.querySelector(
              ".spz_t1020TC .formWrapper .privacyPolicy .MuiCheckbox-root"
            )
          ) {
      ...
      document
        .querySelector(
          ".spz_t1020TC .formWrapper .MuiGrid-item.How_Did_You_Hear_About_Geotab__select label"
        )

      ...
      if (
        ...
        document
          ...
          .addEventListener("click", function () {
            var allFieldsFilled = 0;
            var checkfields = document.querySelectorAll(
              `.spz_t1019 .formWrapper .step2Field div:not(#multiple_region_select__c) + input.MuiSelect-nativeInput,
               .spz_t1019 .formWrapper .step2Field input.MuiInputBase-input,
               .spz_t1019 .formWrapper .step2Field select:not(#multiple_region_select__c)`
            );
            var emptyFields = [];

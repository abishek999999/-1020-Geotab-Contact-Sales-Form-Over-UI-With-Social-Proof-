  ...
  function initVar() {
    var submitCTAInterval = setInterval(async function () {
      if (
        ...
        // Adding Logo
        document
          .querySelector(".spz_t1019 .formWrapper .formcontainer")
          .insertAdjacentHTML(
            "afterbegin",
            `
        ...
        // ADding steps
        if (!document.querySelector(".spz_t1019 .formWrapper .steps")) {
          document
            .querySelector(".spz_t1019 .formWrapper h2")
            .insertAdjacentHTML(
              "beforebegin",
              `
                        <div class="steps">
        ...
        document.querySelector(
          ".spz_t1019 .formWrapper .form-field.multiple_region_select__c label"
        ...
        fields.forEach((field, index) => {
          const element = document.querySelector(".spz_t1019 " + field);
          if (element) {
        ...
        document
          .querySelector(".spz_t1019 .formWrapper .continue")
          .addEventListener("click", function () {
            var allFieldsFilled = 0;
            var checkfields = document.querySelectorAll(
              ".spz_t1019 .formWrapper .step1Field input, .spz_t1019 .formWrapper .step1Field select"
            );
            var emptyFields = [];
            ...
            if (allFieldsFilled === checkfields.length) {
              ...
              if (isValidEmail(email)) {
                document
                  .querySelectorAll(".spz_t1019 .formWrapper .step1Field")
                  .forEach(function (step1Field) {
        ...
        function step2Visible() {
          if (
            ...
            document
              .querySelectorAll(
                ".spz_t1019 .formWrapper .step2Field:not(.city)"
              )
              .forEach(function (step2Field) {
            ...
            var tabletCountryValue = document.querySelector(
              ".spz_t1019 .formWrapper form .form-field.country select"
            );
            if (
              ...
              document.querySelector(
                ".spz_t1019 .formWrapper form .form-field.city"
              ).style.display = "block";
            }

            var desktopCountryValue = document.querySelector(
              ".spz_t1019 .formWrapper form .form-field.country #country"
            );
            if (
        ...
        if (
          ...
          observeElementChanges(
            ...
            function (mutation) {
              if (
                ...
                if (
                  ...
                  if (
                    ...
                    document.querySelector(
                      ".spz_t1019 .formWrapper form .form-field.country"
                    ).style.maxWidth = "calc(50% - 10px)";
                    document.querySelector(
                      ".spz_t1019 .formWrapper form .form-field.country"
                    ).style.flexBasis = "calc(50% - 10px)";
              ...
              document.querySelector(
                ".spz_t1019 .How_Did_You_Hear_About_Geotab__select"
              ).style.maxWidth = "calc(50% - 10px)";
              document.querySelector(
                ".spz_t1019 .How_Did_You_Hear_About_Geotab__select"
              ).style.flexBasis = "calc(50% - 10px)";
          ...
          if (
            ...
            observeElementChanges(
              ...
              function (mutation) {
                ...
                document
                  .querySelector(".spz_t1019 .formWrapper .industry")
                  .after(
                    document.querySelector(
                      ".spz_t1019 .formWrapper .subIndustry"
                    )
                  );
        ...
        observeElementChanges(
          ...
          function (mutation) {
            ...
            if (
              document.querySelectorAll(
                ".spz_t1019 .formWrapper form .form-field.industry"
              ).length < 1 &&
              window.innerWidth < 960
            ) {
              document
        ...
        if (countrySelect) {
          countrySelect.addEventListener("change", function (event) {
            if (event.target.value == "US") {
              ...
              document
                .querySelector(".spz_t1019 .formWrapper form .form-field.city")
                .classList.add("active");
              document.querySelector(
                ".spz_t1019 .formWrapper form .form-field.city #city"
              ).value = "";
        ...
        document
          .querySelector(".spz_t1019 .formWrapper .submitWrapper button")
          .addEventListener("click", function () {
            document.querySelector("#How_Did_You_Hear_About_Geotab__c").value =
              document.querySelector(
                ".spz_t1019 .How_Did_You_Hear_About_Geotab__select .MuiInputBase-input"
              ).value;
          });
        ...
        function multipleRegionSelect() {
          if (
            window.innerWidth < 960 &&
            document.querySelectorAll(
              ".spz_t1019 .formWrapper select#multiple_region_select__c"
            ).length > 0 &&
            ...
            if (
              ...
              document
                .querySelector(
                  ".spz_t1019 .formWrapper .form-field.multiple_region_select__c .MuiInputBase-root"
                )
                .insertAdjacentHTML(
                  "afterend",
                  `
            ...
            const checkboxDropdown = document.querySelector(
              ".spz_t1019 .formWrapper .checkbox-dropdown"
            );
            const dropdownList = document.querySelector(
              ".spz_t1019 .formWrapper .checkbox-dropdown ul"
            );
            ...
            document.addEventListener("click", function (event) {
              ...
              if (!isClickInsideDropdown) {
                ...
                if (
                  document.querySelectorAll(
                    ".spz_t1019 .formWrapper .optionsSelected"
                  ).length > 0
                ) {
                  if (
                    document.querySelector(
        ...
        document
          .querySelector(
            '.spz_t1019 .formSection .formWrapper button[type="submit"]'
          )
          .addEventListener("click", function () {
            var allFieldsFilled = 0;
            var checkfields = document.querySelectorAll(
              '.spz_t1019 .formWrapper .step2Field input.MuiSelect-nativeInput:not([placeholder="Select at least two options"]), .spz_t1019 .formWrapper .step2Field input.MuiInputBase-input, .spz_t1019 .formWrapper .step2Field select:not(#multiple_region_select__c)'
            );
            var emptyFields = [];
          ...
          if (window.outerWidth >= 960) {
            function clickEventListener(event) {
              var inputsToCheck = document.querySelectorAll(
                ".spz_t1019 form .MuiInputBase-root .MuiSelect-select + input"
              );
              inputsToCheck = Array.from(inputsToCheck);
              if (
                !event.target.classList.contains("spz_t1019") &&
      ...
      if (!document.querySelector("checkboxPrivacy")) {
        var containerInterval = setInterval(function () {
          if (
            document.querySelector(
              ".spz_t1019 .formWrapper .privacyPolicy .MuiCheckbox-root"
            )
          ) {
      ...
      // form text changes
      document.querySelector(".spz_t1019 .formWrapper h2").innerHTML =
        "Contact sales";

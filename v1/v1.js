  ...
  function initVar() {
    var submitCTAInterval = setInterval(async function () {
      if (
          ...
          .addEventListener("click", function () {
            ...
            if (allFieldsFilled === checkfields.length) {
              var emailInput = document.querySelector(
                ".spz_t1020 .formWrapper .MuiGrid-item.email input"
              );
              ...
              if (isValidEmail(email)) {
                ...
                document
                  .querySelector(".spz_t1020 .formWrapper .MuiGrid-container")
            ...
            function (mutation) {
              if (
                ...
                if (
                  ...
                  if (
                    document.querySelector(
                      ".spz_t1020 .formWrapper .MuiGrid-item.subIndustry"
                    )
                  ) {
                    document.querySelector(
                      ".spz_t1020 .formWrapper form .form-field.city"
        ...
        observeElementChanges(
          ".spz_t1020 .formWrapper .MuiGrid-container",
          "childList",
          function (mutation) {
            if (
              document.querySelectorAll(
      ...
      document
        .querySelector(
          ".spz_t1020 .formWrapper .MuiGrid-item.How_Did_You_Hear_About_Geotab__select label"
        )

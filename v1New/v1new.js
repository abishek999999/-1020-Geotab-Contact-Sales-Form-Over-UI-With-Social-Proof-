...
(function () {
  ...
  // test 1019 Inject the video background into formSection
  ...
  function initVar() {
    var submitCTAInterval = setInterval(async function () {
      if (
        ...
        document
          .querySelectorAll(
            `.spz_t1020 .formWrapper .MuiGrid-root.first_name,
                .spz_t1020 .formWrapper .MuiGrid-root.last_name,
                .spz_t1020 .formWrapper .MuiGrid-root.company,
                .spz_t1020 .formWrapper .MuiGrid-root.Title__c,
                .spz_t1020 .formWrapper .MuiGrid-root.email,
                .spz_t1020 .formWrapper .MuiGrid-root.industry,
        ...
        document
          .querySelectorAll(
            `.spz_t1020 .formWrapper .MuiGrid-root.multiple_region_select__c,
                  .spz_t1020 .formWrapper .MuiGrid-root.fleet_size,
                  .spz_t1020 .formWrapper .MuiGrid-root.country,
                  .spz_t1020 .formWrapper .MuiGrid-root.city,
                  .spz_t1020 .formWrapper .MuiGrid-root.state,
                  .spz_t1020 .formWrapper .showComment,
                  .spz_t1020 .formWrapper .privacyPolicy,
                  .spz_t1020 .formWrapper .MuiGrid-root.phone,
        ...
        document
          .querySelector(".spz_t1020 .formWrapper .continue")
          .addEventListener("click", function () {
            var allFieldsFilled = 0;
            var checkfields = document.querySelectorAll(
              ".spz_t1020 .formWrapper .step1Field input, .spz_t1020 .formWrapper .step1Field select"
            );
            var emptyFields = [];
            ...
            if (allFieldsFilled === checkfields.length) {
              var emailInput = document.querySelector(
                ".spz_t1020 .formWrapper .MuiGrid-root.email input"
              );
              var email = emailInput.value.trim();
              if (isValidEmail(email)) {
                document
                  .querySelectorAll(".spz_t1020 .formWrapper .step1Field")
                  .forEach(function (step1Field) {
                    step1Field.style.display = "none";
                  });
                document
                  .querySelector(".spz_t1020 .formWrapper .MuiGrid-root")
        ...
        function step2Visible() {
          if (
            document.querySelector(
              ".spz_t1020 .formWrapper .MuiGrid-root.step1Filled"
            )
          ) {
            document
              .querySelectorAll(
                ".spz_t1020 .formWrapper .step2Field:not(.city)"
              )
              .forEach(function (step2Field) {
            ...
            var tabletCountryValue = document.querySelector(
              ".spz_t1020 .formWrapper form .form-field.country select"
            );
            if (
            ...
            var desktopCountryValue = document.querySelector(
              ".spz_t1020 .formWrapper form .form-field.country #country"
            );
            if (
            ...
            function (mutation) {
              if (
                ...
                if (
                  ...
                  if (
                    document.querySelector(
                      ".spz_t1020 .formWrapper .MuiGrid-root.subIndustry"
                    )
                  ) {
                    document.querySelector(
                      ".spz_t1020 .formWrapper form .form-field.city"
              ...
              document.querySelector(
                ".spz_t1020 .How_Did_You_Hear_About_Geotab__select"
              ).style.maxWidth = "calc(50% - 10px)";
              document.querySelector(
                ".spz_t1020 .How_Did_You_Hear_About_Geotab__select"
              ).style.flexBasis = "calc(50% - 10px)";
          ...
          if (
            ...
            observeElementChanges(
              ...
              function (mutation) {
                ...
                document
                  .querySelector(".spz_t1020 .formWrapper .industry")
                  .after(
                    document.querySelector(
                      ".spz_t1020 .formWrapper .subIndustry"
                    )
                  );
        ...
        observeElementChanges(
          ".spz_t1020 .formWrapper .MuiGrid-root",
          "childList",
          function (mutation) {
            if (
              document.querySelectorAll(
            ...
            if (
              document.querySelectorAll(
                ".spz_t1020 .formWrapper form .form-field.industry"
              ).length < 1 &&
              window.innerWidth < 960
            ) {
              document
        ...
        if (countrySelect) {
          countrySelect.addEventListener("change", function (event) {
            if (event.target.value == "US") {
              ...
              document
                .querySelector(".spz_t1020 .formWrapper form .form-field.city")
                .classList.add("active");
              document.querySelector(
                ".spz_t1020 .formWrapper form .form-field.city #city"
              ).value = "";
        ...
        document
          .querySelector(".spz_t1020 .formWrapper .submitWrapper button")
          .addEventListener("click", function () {
            document.querySelector("#How_Did_You_Hear_About_Geotab__c").value =
              document.querySelector(
                ".spz_t1020 .How_Did_You_Hear_About_Geotab__select .MuiInputBase-input"
              ).value;
          });
        ...
        function multipleRegionSelect() {
          if (
            window.innerWidth < 960 &&
            document.querySelectorAll(
              ".spz_t1020 .formWrapper select#multiple_region_select__c"
            ).length > 0 &&
            ...
            if (
              ...
              document
                .querySelector(
                  ".spz_t1020 .formWrapper .form-field.multiple_region_select__c .MuiInputBase-root"
                )
                .insertAdjacentHTML(
                  "afterend",
                  `
            ...
            const checkboxDropdown = document.querySelector(
              ".spz_t1020 .formWrapper .checkbox-dropdown"
            );
            const dropdownList = document.querySelector(
              ".spz_t1020 .formWrapper .checkbox-dropdown ul"
            );
            ...
            document.addEventListener("click", function (event) {
              ...
              if (!isClickInsideDropdown) {
                ...
                if (
                  document.querySelectorAll(
                    ".spz_t1020 .formWrapper .optionsSelected"
                  ).length > 0
                ) {
                  if (
                    document.querySelector(
        ...
        document
          .querySelector(
            '.spz_t1020 .formSection .formWrapper button[type="submit"]'
          )
          .addEventListener("click", function () {
            var allFieldsFilled = 0;
            var checkfields = document.querySelectorAll(
          ...
          if (window.outerWidth >= 960) {
            function clickEventListener(event) {
              var inputsToCheck = document.querySelectorAll(
                ".spz_t1020 form .MuiInputBase-root .MuiSelect-select + input"
              );
              inputsToCheck = Array.from(inputsToCheck);
              if (
                !event.target.classList.contains("spz_t1020") &&
      ...
      if (!document.querySelector("checkboxPrivacy")) {
        var containerInterval = setInterval(function () {
          if (
            document.querySelector(
              ".spz_t1020 .formWrapper .privacyPolicy .MuiCheckbox-root"
            )
          ) {
      ...
      // form text changes
      document.querySelector(".spz_t1020 .formWrapper h2").innerHTML =
        "Contact sales";
                ...
                <div class="rating">
                  <picture>
                    <source
                      ...
                      srcset="
                        https://res.cloudinary.com/spiralyze/image/upload/f_auto/geotab/1020/awards_6.webp
                      "
                    />
                    <img
                      draggable="false"
                      src="https://res.cloudinary.com/spiralyze/image/upload/f_auto/geotab/1020/awards_4.webp"
                      alt="awards logo"
                    />
                  </picture>
                </div>
